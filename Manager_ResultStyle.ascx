<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_ResultStyle.ascx.cs" Inherits="DNNGo.Modules.PowerForms.Manager_ResultStyle" %>
<!-- start: PAGE HEADER -->
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa fa-leaf"></i> <%=ViewResourceText("Header_Title", "Result Effect Style")%></h1>
          </div>
