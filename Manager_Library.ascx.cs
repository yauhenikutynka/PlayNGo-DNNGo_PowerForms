...
{
    public partial class Manager_Library : basePortalModule
    {
        ...
        private void BindDataList()
        {
            ...
            List<DNNGo_PowerForms_Files> Comments = DNNGo_PowerForms_Files.FindAll(qp, out RecordCount);
            ...
            hlFileMateAll.Text = String.Format("{1} ({0})", DNNGo_PowerForms_Files.FindCountByType(PortalId, -1), ViewResourceText("hlFileMateAll", "All"));
            hlFileMateImage.Text = String.Format("{1} ({0})", DNNGo_PowerForms_Files.FindCountByType(PortalId, (Int32)EnumFileMate.Image), ViewResourceText("hlFileMateImage", "Image"));
            hlFileMateZip.Text = String.Format("{1} ({0})", DNNGo_PowerForms_Files.FindCountByType(PortalId, (Int32)EnumFileMate.Zip), ViewResourceText("hlFileMateZip", "Zip"));
            hlFileMateVideo.Text = String.Format("{1} ({0})", DNNGo_PowerForms_Files.FindCountByType(PortalId, (Int32)EnumFileMate.Video), ViewResourceText("hlFileMateVideo", "Video"));
            hlFileMateDoc.Text = String.Format("{1} ({0})", DNNGo_PowerForms_Files.FindCountByType(PortalId, (Int32)EnumFileMate.Doc), ViewResourceText("hlFileMateDoc", "Doc"));
            ...
            BindGridViewEmpty<DNNGo_PowerForms_Files>(gvCommentList, new DNNGo_PowerForms_Files());
        }
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            if (FileType >= 0)
            {
                Where = DNNGo_PowerForms_Files.ByType(Where, FileType);
            }
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(DNNGo_PowerForms_Files._.Name, HttpUtility.UrlDecode(Search_Title), SearchType.Like));
            }
        ...
        protected void gvCommentList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                //还原出数据
                DNNGo_PowerForms_Files Media = e.Row.DataItem as DNNGo_PowerForms_Files;
        ...
        protected void btnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnRemove != null && !String.IsNullOrEmpty(btnRemove.CommandArgument))
                {
                    ...
                    DNNGo_PowerForms_Files Multimedia = DNNGo_PowerForms_Files.FindByKeyForEdit(btnRemove.CommandArgument);
            ...
            try
            {
                ...
                if (Status >= 0)
                {
                    ...
                    for (int i = 0; i < Checkbox_Value_Array.Length; i++)
                    {
                        ...
                        {
                            DNNGo_PowerForms_Files Multimedia = DNNGo_PowerForms_Files.FindByKeyForEdit(IDX);
                            if (Multimedia != null && Multimedia.ID > 0)
                            {
