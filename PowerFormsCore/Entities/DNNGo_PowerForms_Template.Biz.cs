...
namespace DNNGo.Modules.PowerForms
{
	...
	public partial class DNNGo_PowerForms_Template : Entity<DNNGo_PowerForms_Template>
	{
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_PowerForms_Template FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
        ...
        /// <returns></returns>
        public static DNNGo_PowerForms_Template FindByModuleId(Int32 __ModuleId)
        {

            DNNGo_PowerForms_Template entity = Find( _.ModuleId , __ModuleId );
			if (entity == null )
			{ 
				entity = new DNNGo_PowerForms_Template();
			}
			return entity;
        }
		...
		public static List<DNNGo_PowerForms_Template> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
