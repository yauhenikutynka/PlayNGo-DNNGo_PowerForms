...
namespace DNNGo.Modules.PowerForms
{
    ...
    /// <summary>多媒体</summary>
    public partial class DNNGo_PowerForms_Files: Entity<DNNGo_PowerForms_Files> 
    {
        #region 对象操作
        static DNNGo_PowerForms_Files()
        {
            // 用于引发基类的静态构造函数，所有层次的泛型实体类都应该有一个
            DNNGo_PowerForms_Files entity = new DNNGo_PowerForms_Files();
        }
        ...
        public static DNNGo_PowerForms_Files FindByID(Int32 id)
        {
            return Find(_.ID, id);
        }
