...
namespace DNNGo.Modules.PowerForms
{
    ...
    public class Entity<TEntity> : ICloneable where TEntity : Entity<TEntity>, new()
    {
        ...
        /// <returns>实体数组</returns>
        public static List<TEntity> LoadData(DataTable dt)
        {
        ...
        /// <returns>实体数组</returns>
        public static List<TEntity> LoadData(DataTable dt, Type[] jointypes)
        {
        ...
        /// <returns>实体集</returns>
        [DataObjectMethod(DataObjectMethodType.Select, true)]
        public static TEntity FindItem(QueryParam qp, out int RecordCount)
        {
            qp.PageSize = 1;
        ...
        /// <param name="whereClause">限制条件</param>
        /// <returns></returns>
        public static Int32 Delete(QueryParam qp)
        {
            String WhereCase = qp.ToSql();
            return Delete(WhereCase);
        }
