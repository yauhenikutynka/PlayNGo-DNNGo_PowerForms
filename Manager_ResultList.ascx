<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_ResultList.ascx.cs" Inherits="DNNGo.Modules.PowerForms.Manager_ResultList" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <h1>
                <i class="fa clip-list-4"></i> <%=ViewResourceText("Header_Title", "Result Effect List")%></h1>
        </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="background: none; padding: 0px; border: none;">
                                              ...
                                              <%--  &nbsp;&nbsp;&nbsp;&nbsp;--%>
                                               <asp:Literal runat="server" ID="LiDemoUrl"></asp:Literal> <asp:Literal runat="server" ID="LiResponsive"></asp:Literal>
