...
namespace DNNGo.Modules.PowerForms {
	public class Resource_FilesStatus {
        ...
        public Resource_FilesStatus(DNNGo_PowerForms_Files PhotoItem, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, PhotoItem.FileSize, ps, ModulePath); }

        public Resource_FilesStatus(DNNGo_PowerForms_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, fileLength, ps, ModulePath); }

        private void SetValues(DNNGo_PowerForms_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath)
        {
        ...
        public String ViewPicture(DNNGo_PowerForms_Files DataItem, PortalSettings ps, String ModulePath)
        {
        ...
        public String ThumbnailUrl(DNNGo_PowerForms_Files DataItem, PortalSettings ps, String ModulePath)
        {
        ...
        /// <returns></returns>
        public String GetPhotoPath(DNNGo_PowerForms_Files media, PortalSettings ps)
        {
