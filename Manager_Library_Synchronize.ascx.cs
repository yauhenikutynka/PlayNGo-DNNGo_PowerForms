...
{
    public partial class Manager_Library_Synchronize : basePortalModule
    {
        ...
        {
            String WebPath = String.Format("{0}PowerForms/SynchronizeFiles/", PortalSettings.HomeDirectory);
        ...
        public void BindFileList(DirectoryInfo FolderPath)
        {
            ...
            if (SynchronizeFiles != null && SynchronizeFiles.Length > 0)
            {
                ...
                for (int i = 0; i < SynchronizeFiles.Length && i < 5; i++)
                {
                    ...
                    String FileWebPath = String.Format("PowerForms/SynchronizeFiles/{0}", SynchronizeFile.Name);
